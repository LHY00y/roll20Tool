const I18n = (() => {
  ...
  const translations = {
    ko: {
      ...
      cal_tab_datetime: '일자/시간',
      cal_tab_repeat: '반복',
      cal_repeat_daily: '매일',
      cal_repeat_weekly: '매주',
      cal_repeat_monthly: '매월',
      cal_repeat_yearly: '매년',
      cal_repeat_none: '반복 없음',
      cal_repeat_start: '시작일',
      cal_repeat_end: '종료일',
      cal_repeat_ok: '확인',
    },
    en: {
      ...
      cal_tab_datetime: 'Date/Time',
      cal_tab_repeat: 'Repeat',
      cal_repeat_daily: 'Daily',
      cal_repeat_weekly: 'Weekly',
      cal_repeat_monthly: 'Monthly',
      cal_repeat_yearly: 'Yearly',
      cal_repeat_none: 'No repeat',
      cal_repeat_start: 'Start',
      cal_repeat_end: 'End',
      cal_repeat_ok: 'OK',
    }
  };
